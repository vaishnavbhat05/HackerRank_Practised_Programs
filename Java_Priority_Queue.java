...
class Student implements Comparable<Student> {
    ...
    public int compareTo(Student other) {
        if (this.cgpa != other.cgpa) {
            return Double.compare(other.cgpa, this.cgpa); // Sort by CGPA in descending order
        } else if (!this.name.equals(other.name)) {
            return this.name.compareTo(other.name); // Sort by name in ascending order
        } else {
            return Integer.compare(this.id, other.id); // Sort by ID in ascending order
        }
    }
}
